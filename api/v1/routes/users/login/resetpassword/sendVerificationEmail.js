module.exports = (app, utils) => {
    app.post("/api/v1/users/resetpassword/sendVerifyEmail", utils.cors(), async (req, res) => {
        ...
        const verifyEmailUrl = `https://pmprojects.kokodev.cc/api/v1/resetpassword/verifyemail?email=${email}&state=${state}`;

        const emailHtml = `<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "http://www.w3.org/TR/REC-html40/loose.dtd">
        <html><body>
        <p style='background-color: #129aeb; color: white; font-size: 48px; font-weight: bold; font-family: "Helvetica Neue", Arial, sans-serif; padding: 60px 10%;' align="center">OrangeMod Email Verification</p>
        ...
        <br>
        <p style='font-family: "Helvetica Neue", Arial, sans-serif;'>If you did not request for this to be a OrangeMod account's email, you can delete this email or ignore it.</p>
        ...
        const emailPlainText = `OrangeMod Email Verification
